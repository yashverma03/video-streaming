...
- Implemented media player, channel management, video search, views and likes engagement metrics.
- Integrated Youtube API to play video directly within media player and increased user engagement by 36%.
- Tech: HTML, CSS, JavaScript, React.js, Material UI, Youtube API.
